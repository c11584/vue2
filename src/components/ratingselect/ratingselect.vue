<template>
	<div class="ratingselect">
		<div class="rating-type border-1px">
			<span v-on:click="select(2, $event)" class="block positive" :class="{'active':selectType===2}">{{desc.all}}<span class="count">{{ratings.length}}</span></span>
		...
		<div v-on:click="toggleContent" class="switch" :class="{'on':onlyContent}">
