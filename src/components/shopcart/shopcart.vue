	...
	<div class="shopcart-root">
		<div class="shopcart">
			...
			<div class="ball-container">
				<transition-group name="drop" v-on:before-enter="beforeEnter" v-on:enter="enter" @afterEnter="afterEnter">
...
//						let y = rect.top - 22;
			...
			pay() {
				if (this.totalPrice >= this.minPrice) {
					this.$emit('pay', this.selectFoods);
				}
			}
		},
		components: {
...
<style lang="stylus" rel="stylesheet-stylus">
	...
	.shopcart
		...
		.shopcart-list
			...
			width: 100%
			transition: all 0.5s
			//&.fold-transition, &.fold-enter-active
